...
const Header = () => {
  ...
  const link = [{ href: "/gallery", name: "GALLERY" }, { href: "/services", name: "SERVICE" }, { href: "/about", name: "ABOUT" }, { href: "/contact", name: "CONTACT" }]
  return (
    <header className="w-full border-b py-6 px-6 md:px-24 flex h-30">
      ...
      <div className='hidden lg:flex justify-center items-center w-2/3'>
        <ul className='flex md:flex-wrap justify-center items-center text-xl lg:text-2xl overflow-hidden'>
          {
        ...
        <div>
          <ul className='flex justify-center items-center'>
            <li className='flex justify-center items-center w-full md:w-16'>
